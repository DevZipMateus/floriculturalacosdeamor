...
import { buques } from '@/data/products';
      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <a
              href="https://api.whatsapp.com/send/?phone=558001813000&text=Olá! Gostaria de encomendar um buquê premium.&type=phone_number&app_absent=0"
              target="_blank"
