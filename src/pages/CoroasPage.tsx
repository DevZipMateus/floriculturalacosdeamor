        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            <h1 className="text-3xl md:text-4xl font-bold text-floral-burgundy mb-4">
              Coroas de Flores para Velório
            </h1>
            <p className="text-lg text-foreground/80 max-w-2xl mx-auto mb-6">
              Entrega imediata em Goiânia e região. Homenageie com carinho e respeito.
            </p>
            <a
          ...
          <ProductGallery images={coroas} categoryName="Coroa de Flores" />
        </div>
      </main>
      <Footer />
      <WhatsAppButton />
