      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-white mb-8 max-w-2xl mx-auto drop-shadow-md">
            Homenageie com carinho, respeito e pontualidade. Atendimento 24 horas.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            <a 
              ...
              className="flex items-center gap-3 bg-[#25D366] hover:bg-[#20BD5C] text-white px-8 py-4 rounded-md text-lg font-semibold transition-colors shadow-lg"
            >
              ...
              Atendimento Imediato – Coroas para Velório
            </a>
            <Link 
              to="/coroas"
              className="flex items-center gap-2 bg-floral-burgundy hover:bg-floral-burgundy/90 text-white px-8 py-4 rounded-md text-lg font-medium transition-colors shadow-lg"
            >
              Ver Modelos de Coroas
            </Link>
          </div>
        </div>
      </div>
