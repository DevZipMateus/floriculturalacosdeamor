      ...
      {isOpen && (
        <div className="mb-4 bg-white rounded-lg shadow-lg p-4 max-w-xs service-card animate-slide-up">
          <div className="flex justify-between items-center mb-3">
            <h3 className="font-bold text-floral-burgundy">Precisa de ajuda?</h3>
            <button 
          ...
          <p className="text-floral-burgundy/70 text-sm mb-3">
            Olá! Estamos aqui para ajudar com suas dúvidas sobre nossos arranjos florais.
          </p>
          <a
